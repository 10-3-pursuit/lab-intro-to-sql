...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift TEXT NOT NULL, giver TEXT NOT NULL, price INT, previously_regifted BOOLEAN DEFAULT false);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('orange juice', 'Vytmyn Cee', '24', FALSE),
('soccer ball', 'Neymar', '15', TRUE),
('umbrella', 'Raynee Dae', '20', FALSE),
('coffee mug', 'Kohfae', '15', FALSE),
('necklace', 'Jule Ree', '45', TRUE)
;
