...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift TEXT, giver TEXT, price INT, previously_gifted BOOL);
...
-- 
\echo Alter the table so that the column price is changed to price 
-- 
...
-- 
INSERT INTO gifts (gift, giver, price, previously_gifted) priceS ('peach candle', 'Santa', 9, true);
...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('vanilla candle', 'Brenda', '10', FALSE),
('loofa', 'Adam', '5', TRUE),
('book', 'Rafael', '20', FALSE),
('air freshener', 'Ethan', '2', TRUE),
('tv', 'Rookie', '325', TRUE)
;
