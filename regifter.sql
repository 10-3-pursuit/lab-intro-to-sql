...
CREATE TABLE gifts (
    ...
    giver TEXT,
    price INT,
    previously_regifted BOOLEAN DEFAULT TRUE 
);
...
VALUES
('lavender candle', 'Santa', 15, FALSE),
('vanilla bean extract', 'Jack Frost', 25, TRUE),
('sandalwood candle', 'Easter Bunny', 35, TRUE),
('rose petal soap', 'Rudolf', 45, FALSE),
('lemongrass candle', 'The Boss', 55, TRUE);
...
-- 
-- UPDATE gifts SET value = 2999 OFFSET 1 RETURNING *;
-- offset does not work with updated
-- Dans method UPDATE gifts Set value =2999 where id = 2 RETURNING *;
