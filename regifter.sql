...
INSERT INTO gifts (gift, giver, price, previously_regifted)
VALUES
('green tea soap', 'Artisan Soaps', '8', TRUE),
('banana bomb', 'Goblin', '99', TRUE),
('apple sauce', 'Angel', '6', FALSE),
('curry', 'Merchant Man', '10', TRUE),
('water soaker', 'Turtle Mom', '67', FALSE)
;

--
\echo Query for gifts with a price greater than or equal to 20
--
SELECT gift FROM gifts WHERE price >= 20; 
...
-- 
SELECT COUNT(gift) FROM gifts WHERE gift = '%Santa%';
